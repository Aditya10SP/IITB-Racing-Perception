...
class DepthFinder:
	...
	def __init__(self, focus = 500000, baseline = 120, pixel_size = 0.002):
		"""
...
class Triangulation:
	...
	def __init__(self, focus, baseline, pixel_size):
		"""
	...
	def find_depth(self, left_points, right_points):
		...
		disparities = abs(left_points - right_points)[:,0].clone().detach().requires_grad_(True).reshape(-1,1)
